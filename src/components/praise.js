                ...
                <div className="typography-line">
                  <blockquote>
                    <p className="blockquote blockquote">
                      ...
                      you excited about the opportunities for improvement within
                      your own company. If NZFS can do it. Surely we can too. It
                      also includes the academic details to back up the
                      practices and appeal to those that need more detail."{" "}
                      <br></br>
                      <br></br>
                  ...
                  <blockquote>
                    <p className="blockquote blockquote">
                      ...
                      perspective of Julie, the new Technology Manager at the
                      fictional NZFS, it provides practical descriptions and
                      scenarios which will undoubtably be familiar to anyone who
                      has worked in a large company. Highly recommended for
                      anyone looking to improve their customer engagement and
                      streamline their work processes." <br></br>
                      <br></br>
