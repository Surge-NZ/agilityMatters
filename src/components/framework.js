...
import * as styles from "./framework.module.css";
  ...
  return (
    <Container className={styles.container}>
      <Row md={12}>
        ...
        <Row md={12} className={styles.imageTitleSubtitleContainer}>
          <StaticImage
            src="../images/aso-framework.png"
            alt="ASO Framework flowchart image"
            placeholder="blurred"
          ...
          <TitleSubtitle
            title=""
            subtitle="ASO Framework Model (as seen in Agility Matters)"
          />
        </Row>
      </Row>
    </Container>
